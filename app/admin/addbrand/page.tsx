  ...
  return (
     <div className="min-h-screen  flex items-center justify-center px-4 mt-20">
      ...
      <div className="bg-primary w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl rounded-2xl shadow-xl p-6 sm:p-8">
        ...
        {/* Title */}
       <h1 className='text-center text-secondary font-bold text-xl mb-6'>Add Brand</h1>
        ...
        <div className='flex gap-6'>
          ...
          <button className="w-full bg-secondary hover:bg-secondary/90 text-white py-3 rounded-lg font-semibold text-base sm:text-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-lg cursor-pointer" onClick={()=>{handleAddBrand()}}>
          Add Brand
        </button>
